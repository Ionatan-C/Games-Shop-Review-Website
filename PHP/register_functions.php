...
<?php   //runs a piece of code that gets the input from the user and stores it to a variable and then uses it to connect with the user a little bit more, this is for the registration form

        $name = $_POST["name"];

        echo '<p style="color: black; font-size: 40px; text-align: center;">Thank you for Registering in with us '. $name;
