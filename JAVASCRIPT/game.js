document.addEventListener("DOMContentLoaded", function () {
    ...
    btn.addEventListener("click", function() {/*This adds an event when the button is clicked*/
        ...
        .then(data => { /*This runs the code bellow*/
            ...
            console.log(data[0]) /*This calls the data from the json file and selects a certain bit of it / a certain data from the array*/
            document.querySelector("#info-txt").innerText = data[0].city /*This calls the bit of information from the json data*/
            document.querySelector("#info-txt1").innerText = data[0].location /*This calls the bit of information from the json data*/
